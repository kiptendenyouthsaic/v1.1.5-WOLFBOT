...
export default {
  ...
  update: {
    ...
    repository: {
      // Your main repository (your current bot)
      main: "https://github.com/WOLVAREX/v1.1.5-WOLFBOT-",
      
      // Remote repository (where updates come from)
      upstream: "https://github.com/WOLVAREX/v1.1.5-WOLFBOT-.git",
      
      // Backup owner repository (if needed)
      owner: "https://github.com/WOLVAREX/v1.1.5-WOLFBOT-"
    },
    
    // ZIP update URL (fallback method)
    zipUrl: "https://github.com/WOLVAREX/v1.1.5-WOLFBOT-/archive/refs/heads/main.zip",
